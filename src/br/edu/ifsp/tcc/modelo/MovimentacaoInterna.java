...
public class MovimentacaoInterna implements Serializable {
    ...
    @Column(name = "movimentacao_interna_id",nullable = false)
    private Integer id;
    ...
    @Column(name = "tipo", length = 2, nullable = false) /*EX -> Exclusão ************ IN -> Inclusão*/
    private String tipo;
...
////
    ...
    public MovimentacaoInterna(Integer id, Date dataMovimentacao, Date dataOcorrido, String tipo, Presidio presidio, Sentenciado sentenciado) {
        this.id = id;
    ...
    public String toString() {
        return "MovimentacaoInterna{" + "id=" + id + ", dataMovimentacao=" + dataMovimentacao + ", dataOcorrido=" + dataOcorrido + ", tipo=" + tipo + ", presidio=" + presidio + ", sentenciado=" + sentenciado + '}';
    }
