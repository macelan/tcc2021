...
CREATE database tccv60;
USE tccv60 ;

-- -----------------------------------------------------
-- Table bcctccVilson.pavilhao
-- -----------------------------------------------------
CREATE TABLE pavilhao (
  pavilhao_id INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS coordenadoria (
  coordenadoria_id INT NOT NULL AUTO_INCREMENT,
  nome VARCHAR(170) NULL DEFAULT NULL,
  sigla VARCHAR(10) NULL DEFAULT NULL,
  PRIMARY KEY (coordenadoria_id));


-- -----------------------------------------------------
-- Table evento_coletivo
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS evento_coletivo (
  evento_coletivo_id INT NOT NULL AUTO_INCREMENT,
  pavilhao_id INT NULL DEFAULT NULL,
  data_ocorrido DATE NULL DEFAULT NULL,
  data_registro DATETIME NULL DEFAULT NULL,
  relato VARCHAR(500) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS faccao (
  faccao_id INT NOT NULL AUTO_INCREMENT,
  nome VARCHAR(70) NULL DEFAULT NULL,
  sigla_faccao VARCHAR(10) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS presidio (
  presidio_id INT NOT NULL AUTO_INCREMENT,
  coordenadoria_id INT NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS funcionario (
  ...
  presidio_id INT NULL DEFAULT NULL,
  sindicancia_id INT NULL DEFAULT NULL,
  rg VARCHAR(18) NULL DEFAULT NULL,
...
-- Table sentenciado
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS sentenciado (
  sentenciado_id INT NOT NULL AUTO_INCREMENT,
  faccao_id INT NULL DEFAULT NULL,
  matricula VARCHAR(13) NOT NULL,
  nome VARCHAR(60) NOT NULL,
  rg VARCHAR(13) NULL DEFAULT NULL,
  data_nascimento DATE NULL DEFAULT NULL,
  aliases VARCHAR(30) NOT NULL,
  registro_ativo TINYINT(1) NULL DEFAULT NULL,
  PRIMARY KEY (sentenciado_id),
  FOREIGN KEY (faccao_id)    REFERENCES faccao (faccao_id));

-- -----------------------------------------------------
-- Table movimentacao_externa
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS movimentacao_externa (
  sentenciado_id INT NOT NULL,
  movimentacao_externa_id INT NOT NULL,
  data_movimentacao DATE NULL DEFAULT NULL,
  data_registro DATETIME NULL DEFAULT NULL,
  tipo VARCHAR(12) NULL DEFAULT NULL,
  presidio_id INT NOT NULL,
  PRIMARY KEY (sentenciado_id, movimentacao_externa_id),
  FOREIGN KEY (sentenciado_id) REFERENCES sentenciado (sentenciado_id),
  FOREIGN KEY (presidio_id)   REFERENCES presidio (presidio_id));


-- -----------------------------------------------------
-- Table movimentacao_interna
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS movimentacao_interna (
  sentenciado_id INT NOT NULL,
  movimentacao_interna_id INT NOT NULL,
  cela_id INT NULL DEFAULT NULL,
  data_movimentacao DATE NULL DEFAULT NULL,
  data_registro DATETIME NULL DEFAULT NULL,
  tipo VARCHAR(2) NULL DEFAULT NULL,
  PRIMARY KEY (sentenciado_id, movimentacao_interna_id),
...
CREATE TABLE IF NOT EXISTS observacao (
  observacao_id INT NOT NULL AUTO_INCREMENT,
  sentenciado_id INT NOT NULL,
  relato VARCHAR(500) NULL DEFAULT NULL,
  data_ocorrido DATE NULL DEFAULT NULL,
  data_registro DATETIME NULL DEFAULT NULL,
...
-- Table sindicancia
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS sindicancia (
  sindicancia_id INT NOT NULL AUTO_INCREMENT,
  relato VARCHAR(500) NULL DEFAULT NULL,
  data_ocorrido DATE NULL DEFAULT NULL,
  data_registro DATETIME NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table sindicancia_funcionario
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS sindicancia_funcionario (
  funcionario_id INT NOT NULL,
  sindicancia_id INT NOT NULL,
...
-- -----------------------------------------------------
-- Table sindicancia_sentenciado
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS sindicancia_sentenciado (
  sentenciado_id INT NOT NULL,
  sindicancia_id INT NOT NULL,
